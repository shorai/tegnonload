...
c:\"program files"\7-zip\7z.exe a c:\SQLBackups\TegnonEfficiency_monthly_%date:~-4,4%%date:~-10,2%%date:~-7,2%.zip c:\SQLBackups\log.txt c:\SQLBackups\TegnonEfficiency_monthly_*.* c:\inetpub\wwwroot "c:\users\chris.rowse\my documents\NetbeansProjects\tegnonload"
...
REM this should copy to glacier storage - Keep for 24 months
